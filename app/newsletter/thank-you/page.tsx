  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-2xl w-full text-center">
        <div className="bg-white rounded-3xl shadow-xl p-12 animate-scale-up">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 mb-8">
            ...
            <ul className="space-y-3 text-left max-w-md mx-auto">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  Get weekly updates on new features, tips, and best practices
                </span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700">
                  Be the first to know about special offers and events
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">Follow us for more updates</h3>
